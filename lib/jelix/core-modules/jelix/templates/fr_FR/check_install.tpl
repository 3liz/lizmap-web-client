...
<div id="page">
    ...
    <div class="nocss">
        ...
        <p>Si vous voulez utiliser un autre nom que jelix pour ce dossier,
           ...
           dans <em>{$configpath}mainconfig.ini.php</em>.</p>
        <p>Pour plus d'informations, consultez
             <a href="http://docs.jelix.org/fr/manuel-1.6/configurer-server"
    ...
    <div class="block">
        ...
        <div class="blockcontent">
            <ul>
                ...
                <li><a href="http://docs.jelix.org/fr/manuel-1.6">Lisez la documentation de Jelix</a></li>
