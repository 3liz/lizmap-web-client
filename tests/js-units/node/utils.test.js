...
describe('Utils', function () {
    ...
    it('fetch', async function () {
        ...
        data = await Utils.fetch(
            'http://localhost:8130/index.php/lizmap/service',
            {
                method:'POST',
    ...
    it('fetch error', async function () {
        ...
        client
        .intercept({
            path: (path) => path.includes('bad/gateway'),
            method: 'GET',
        })
        .reply(502, {
            message: 'Bad gateway',
        ...
        client
        .intercept({
            path: (path) => path.includes('gateway/timeout'),
            method: 'GET',
        })
        .reply(504, {
        ...
        */
        ...
        try {
            await Utils.fetch(
                'http://localhost:8130/index.php/lizmap/unknown',
                {
                    method:'POST',
                    body: 'repository=test&project=test',
                })
