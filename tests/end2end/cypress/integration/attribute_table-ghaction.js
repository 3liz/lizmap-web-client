describe('Attribute table', () => {
    ...
    it('should select / filter / refresh', () => {
        ...
        // select feature 2
        cy.get('#attribute-layer-table-quartiers tr[id="2"] button.attribute-layer-feature-select').click({ force: true })
        cy.wait('@getMap')
        ...
        cy.get('#attribute-layer-table-quartiers tr[id="2"] button.attribute-layer-feature-select').click({ force: true })
        cy.get('#attribute-layer-table-quartiers tr[id="4"] button.attribute-layer-feature-select').click({ force: true })
        cy.get('#attribute-layer-table-quartiers tr[id="6"] button.attribute-layer-feature-select').click({ force: true })
        cy.wait('@getMap')
        ...
        // select feature 2
        cy.get('#attribute-layer-table-quartiers_shp tr[id="2"] button.attribute-layer-feature-select').click({ force: true })
        ...
        // select feature 2,4,6
        cy.get('#attribute-layer-table-quartiers_shp tr[id="2"] button.attribute-layer-feature-select').click({ force: true })
        cy.get('#attribute-layer-table-quartiers_shp tr[id="4"] button.attribute-layer-feature-select').click({ force: true })
        cy.get('#attribute-layer-table-quartiers_shp tr[id="6"] button.attribute-layer-feature-select').click({ force: true })
