...
export class SelectionPage extends ProjectPage {
    ...
    getExportFormatsItems() {
        return this.getExportFormatsList().locator('a');
    }
    ...
    async selectGeometry(type) {
        await this.getDigitizingToolBar().locator('.dropdown-toggle:nth-child(2)').click();
        await this.getDigitizingToolBar().locator(`.digitizing-${type} > svg`).click();
    }
