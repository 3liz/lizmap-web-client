...
test.beforeEach(async ({ page }) => {
    const url = '/index.php/view/map?repository=testsrepository&project=permalink#3.7980645260916805,43.59756940064654,3.904383263124536,43.672963842067254|sousquartiers,Les%20quartiers%20%C3%A0%20Montpellier|red,d%C3%A9faut|0.6,0.8';
