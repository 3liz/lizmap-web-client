...
test.describe('Layer export permissions', () => {
    ...
    [
        ...
        test(`#${c} Layer export with ${login} user logged in`, {
            ...
            // go to project page
            const project = new ProjectPage(userPage, 'enable_export');
            await project.open();
    ...
    test('Layer export request', {
        ...
        const project = new ProjectPage(page, 'enable_export');
        await project.open();
        await project.openAttributeTable('single_wms_points');

        // launche export
        await project.launchExport('single_wms_points','3.8308870374061232%2C43.5976501168972%2C3.9342777189191174%2C43.647116478434526')
    })
});
