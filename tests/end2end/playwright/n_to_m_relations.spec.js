...
test.describe('N to M relations', () => {
    ...
    test('Popup behavior', async ({ page }) => {
        ...
        await expect(page.locator(".container.popup_lizmap_dd").nth(0).locator(".before-tabs div.control-group span.jforms-control-input")).toHaveCount(2);
        await expect(page.locator(".container.popup_lizmap_dd").nth(0).locator(".before-tabs div.control-group span.jforms-control-input").nth(0)).toHaveText("1");
        await expect(page.locator(".container.popup_lizmap_dd").nth(0).locator(".before-tabs div.control-group span.jforms-control-input").nth(1)).toHaveText("Étang du Galabert");
