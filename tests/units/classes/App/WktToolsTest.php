 ...
 * @coversNothing
 */
class WktToolsTest extends TestCase
{
    public function testChecking(): void
    {
        ...
        foreach ($notWktArray as $wkt) {
            $this->assertFalse(WktTools::check($wkt), 'The '.$wkt.' has been checked!');
        }
    }
    ...
    public function testMultiPoint(): void
    {
        ...
        $this->assertEquals(
            json_encode($geom),
            '{"type":"MultiPoint","coordinates":[[30,10]]}'
        );
    }
    ...
    public function testMultiLineString(): void
    {
        ...
        $this->assertEquals(
            json_encode($geom),
            '{"type":"MultiLineString","coordinates":[[[30,10],[10,30],[40,40]]]}'
        );
    }
    ...
    public function testMultiPolygon(): void
    {
        ...
        $this->assertEquals(
            json_encode($geom),
            '{"type":"MultiPolygon","coordinates":[[[[30,10],[40,40],[20,40],[10,20],[30,10]]]]}'
        );
    }
