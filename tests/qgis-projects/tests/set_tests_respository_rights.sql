...
VALUES
    ...
    ('read_only', 'read_only', 0, null),
    ('__priv_user_read_only', 'user_read_only', 2, 'user_read_only'),
...
VALUES
    ...
    ('user_read_only', 'user_read_only@nomail.nomail', '$2y$10$d2KZfxeYJP0l3YbNyDMZYe2vGSA3JWa8kFJSdecmSEIqInjnunTJ.', 1, NOW(), 'User Read Only', 'TuPeuxPasTest', 'Make it KISS'),
...
VALUES
    ...
    ('user_read_only', '__priv_user_read_only'),
...
VALUES
    ...
    -- ...for read only users
    ('lizmap.repositories.view', 'read_only', 'testsrepository', 0),
