...
export default class Search {
    ...
    _addSearch(searchConfig) {
        ...
        extent.transform(this._lizmap3.map.getProjection(), wgs84);
        ...
        $('#nominatim-search').submit(() => {
            ...
            switch (searchConfig.service) {
                case 'nominatim':
                    ...
                    break;
                case 'ign':
                    let mapExtent4326 = transformExtent(this._map.getView().calculateExtent(), this._lizmap3.map.getProjection(), 'EPSG:4326');
