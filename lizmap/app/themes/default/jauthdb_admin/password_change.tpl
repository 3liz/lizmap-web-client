...
<p><a href="{jurl $viewaction, array('j_user_login'=>$id)}" class="crud-link btn btn-sm">{if $personalview}{@jauthdb_admin~crud.link.return.to.view@}{else}{@jauthdb_admin~user.link.return.to.view@}{/if}</a>.</p>
</div>
