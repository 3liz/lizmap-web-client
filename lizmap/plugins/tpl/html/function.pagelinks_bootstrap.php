 ...
 *  */
function jtpl_function_html_pagelinks_bootstrap($tpl, $action, $actionParams, $itemsTotal, $offset, $pageSize = 15, 
                                      $paramName = 'offset', $displayProperties = array())
{
    ...
    else echo '<div class="pagination"><ul class="pagelinks"><li class="pagelinks-current"><a href="#">1</a></li></ul></div>';
}
