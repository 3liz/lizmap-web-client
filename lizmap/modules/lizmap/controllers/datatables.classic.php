...
class datatablesCtrl extends jController
{
     ...
     *
     * @param jResponsJson $rep          - the response object to which the error details will be assigned
    ...
    public function index()
    {
        ...
        if (!is_array($DTColumns) || count($DTColumns) == 0) {
            return $this->setErrorResponse($rep, 400, 'The DataTables parameter columns '.json_encode($DTColumn).
            ' is not well formed.');
        }
