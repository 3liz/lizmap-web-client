...
class editionCtrl extends jController
{
    ...
    private function addFormControls($form)
    {
        ...
        foreach ($this->dataFields as $fieldName => $prop) {
            ...
            if (($this->formControls[$fieldName]->fieldEditType == 15 or
                $this->formControls[$fieldName]->fieldEditType == 'ValueRelation') and
                $this->formControls[$fieldName]->valueRelationData
            ) {
            ...
            } elseif ($this->formControls[$fieldName]->fieldEditType == 8
    ...
    private function fillControlFromValueRelationLayer($fieldName)
    {
        ...
        if ($wfsData and !in_array(strtolower($mime), array('text/html', 'text/xml'))) {
            ...
            // required
            if (strtolower($this->formControls[$fieldName]->valueRelationData['allowNull']) == 'false' or
            ...
            // orderByValue
            if (strtolower($this->formControls[$fieldName]->valueRelationData['orderByValue']) == 'true' or
     ...
     *
     * @return bool True if filled form
     */
    ...
    // Get database connection object
        ...
        foreach ($rs as $record) {
            ...
            foreach ($this->dataFields as $ref => $prop) {
                ...
                if ($this->formControls[$ref]->fieldEditType == 15 or
                    $this->formControls[$ref]->fieldEditType === 'ValueRelation'
                ) {
                    $value = $record->{$ref};
                    if ($value[0] == '{') {
                ...
                if ($this->formControls[$ref]->fieldEditType == 8 or
                    $this->formControls[$ref]->fieldEditType == 'FileName' or
                    $this->formControls[$ref]->fieldEditType == 'Photo'
                ) {
     ...
     * @param object $form Jelix jForm object
     *
     * @return bool True if the has been saved
     */
