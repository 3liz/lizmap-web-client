...
class lizMapCtrl extends jController
{
    ...
    public function index()
    {
        ...
        $lizUrls = array(
            ...
            'wms' => jUrl::get('lizmap~service:oldindex'),
            ...
            'dataTables' => jUrl::get('lizmap~datatables:index'),
            'dataTableLanguage' => $bp.'assets/js/dataTables/'.jApp::config()->locale.'.json',
            'dataTablesFilteredFeaturesExtent' => jUrl::get('lizmap~datatables:filteredFeaturesExtent'),
            'dataTablesSelectFilteredFeatures' => jUrl::get('lizmap~datatables:selectFilteredFeatures'),
            ...
            'service' => jUrl::get('lizmap~service:oldindex', array('repository' => $repository, 'project' => $project)),
            'featuresDisplayExpression' => jUrl::get('lizmap~features:displayExpression', array('repository' => $repository, 'project' => $project)),
            'featuresTooltips' => jUrl::get('lizmap~features:tooltips', array('repository' => $repository, 'project' => $project)),
