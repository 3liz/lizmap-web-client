...
<tfoot>
    <tr>
        <td><input type="submit" value="{@jacl2db_admin~acl2.delete.button@}" class="btn"/></td>
        <td></td>
    </tr>
</tfoot>
<tbody>
...
<p><a href="{jurl 'jacl2db_admin~groups:rights'}" class="btn">{@jacl2db_admin~acl2.link.return.to.rights@}</a></p>
