...
<tfoot>
    <tr>
        <td></td>
        <td><input type="submit" value="{@jacl2db_admin~acl2.save.button@}" class="btn"/></td>
        <td></td>
        {if $nbgrp}
        <td colspan="{$nbgrp}"></td>
        {/if}
...
<tr class="{cycle array('odd','even')}">
    ...
    <td>
        <select name="rights[{$subject}]" id="{$subject|eschtml}" class="input-medium user-right-authorization">
