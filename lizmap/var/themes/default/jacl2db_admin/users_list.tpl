...
{formurlparam 'jacl2db_admin~users:index'}
    ...
    <input type="submit" value="{@jacl2db_admin~acl2.show.button@}" class="btn"/>
</fieldset>
</form>
...
<div class="record-pages-list">{@jacl2db_admin~acl2.pages.links.label@} {pagelinks_bootstrap 'jacl2db_admin~users:index', array('grpid'=>$grpid),  $usersCount, $offset, $listPageSize, 'idx' }</div>
{/if}
