...
class myHtmlAdminResponse extends jResponseHtml {

  public $bodyTpl = 'admin~main';
  ...
  protected function doAfterActions() {
    ...
    $this->body->assignZoneIfNone('MENU', 'admin~admin_menu', array('selectedMenuItem'=>$this->body->get('selectedMenuItem')));
